...
<html>
<head>
<title>Creation de licence</title>
<style>
.error {
	color: red;
}
...
<h1>Cr&eacute;ation d'une nouvelle adh&eacute;sion pour ${username}</h1>
<p align="left">
<button type="button" onClick='location.href="gererAdherents.jsp";'>Retour</button>
</p>
